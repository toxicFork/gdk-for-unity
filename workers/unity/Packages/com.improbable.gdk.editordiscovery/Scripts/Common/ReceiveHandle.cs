...
internal class ReceiveHandle
{
    ...
    private ManualResetEvent killTrigger;
    ...
    public ReceiveHandle(UdpClient client, int packetReceiveTimeoutMs, ManualResetEvent killTrigger)
    {
        this.client = client;
