    ...
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            var packages = new List<Package>
            {
                ...
                new Package(tempPath, "worker_sdk", "c-static-fullylinked-arm-clang_libcpp-ios", $"{nativeDependenciesPath}/iOS/arm", new List<string> {"include", "libworker_static_fullylinked.a.pic", "worker_static_fullylinked.lib"}, postprocessCallback:PostProcessIosArm),
                new Package(tempPath, "worker_sdk", "c-static-fullylinked-x86_64-clang_libcpp-ios", $"{nativeDependenciesPath}/iOS/x86_64", new List<string> {"include", "libworker_static_fullylinked.a.pic", "worker_static_fullylinked.lib"}, postprocessCallback:PostProcessIosx8664),
        ...
        private static void PostProcessIosArm(string directoryPath)
        {
        ...
        private static void PostProcessIosx8664(string directoryPath)
        {
            var originalPath = Path.Combine(directoryPath, "libworker_static_fullylinked.a");
