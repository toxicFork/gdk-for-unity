...
namespace Improbable.Gdk.GameObjectRepresentation
{
    ...
    public class InjectableFactory
    {
        ...
        internal IInjectable CreateInjectable(InjectableId injectableId, Entity entity, Entity workerEntity)
        {
            ...
            return injectableIdToReaderWriterCreator[injectableId].CreateInjectable(entity, workerEntity, entityManager, logger);
        }
    }
}
